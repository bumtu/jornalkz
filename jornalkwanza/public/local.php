...
$result = queryMysql("SELECT * FROM noticias WHERE zona='$location' ORDER BY id DESC");
$num = $result->rowCount();
        ...
        <div class='left-content'>
            ...
            <div class='for-you'>
                ...
                <div class='atuais-seg'>
                    ...
                    <a href='local.php'><span class='tdasTxt' style='color: #950101; text-decoration: underline;'>Local</span>
                    <div class='tdas-newsIcon'>
...
if($num == 0){
    echo "
        <div class='center-content'>
            ...
            <h2>Não exitem noticias neste local.</h2>
        </div>
    ";
...
if(!$loggedin){
                        ...
                        echo"  
                            <div class='content-index'>
                                ...
                                <div class='noticia-content'>
                                    ...
                                    <a href='#'><div class='cmmt' id='cmntrs'>
                                        <p>$ncmmts</p>
                                    </div></a>
    ...
    echo <<<_SCRIPT
        ...
        function logeddin(userId){
            alert('É necessário cadastrar-se ou fazer login');
        }

    </script>
_SCRIPT;
//Se usuario não estiver cadastrado.
